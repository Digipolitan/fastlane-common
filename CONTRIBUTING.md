# Contributing to Digipolitan fastlane-common
...
* **Did the problem start happening recently** (e.g. after updating to a new version of fastlane-common) or was this always a problem?
* If the problem started happening recently, **can you reproduce the problem in an older version of fastlane-common ?** What's the most recent version in which the problem doesn't happen? You can download older versions of fastlane-common from [the releases page](https://github.com/digipolitan/fastlane-common/releases).
* **Can you reliably reproduce the issue?** If not, provide details about how often the problem happens and under which conditions it normally happens.

Include details about your configuration and environment:

* **Which version of fastlane-common are you using?
...
#### Template For Submitting Bug Reports
    ...
    **fastlane-common version:** [Enter fastlane-common version here]
    ...
    * Problem started happening recently, didn't happen in an older version of fastlane-common: [Yes/No]
